...
function ServiceUsers() {
  ...
  return (
    <>
      <>
        {deleteServiceUserMutation.isLoading && <LoadingAlert msg='Deleting ...' />}
        {deleteServiceUserMutation.isSuccess && <SuccessAlert msg='Successfully Deleted' />}
        {deleteServiceUserMutation.isError && <ErrorAlert msg='Failed! Try again...' />}
                    ...
                    <tr>
                      ...
                      <th scope='col' className='px-6 py-3 text-center'>
                        <p className='flex items-center justify-center gap-2'>
                          ...
                          <span className='text-gray-800'>Car Name/Car Model</span>
                        </p>
                      </th>
                      <th scope='col' className='px-6 py-3 text-center'>
                        <p className='flex items-center justify-center gap-2'>
                    ...
                    {isLoading ? (
                      ...
                      data.map((users) => (
                        ...
                        >
                          ...
                          <td className='px-6 py-4 text-gray-700 text-center'>{users.cityName}</td>
