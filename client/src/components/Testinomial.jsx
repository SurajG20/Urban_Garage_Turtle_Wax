          ...
          <li>
            <div className="blog-card">
              <figure className="card-banner">
                ...
                <Link to="#" className="btn card-badge text-theme-semibold">
                  Naveen Mishra
                </Link>
              </figure>
          ...
          <li>
            <div className="blog-card">
              <figure className="card-banner">
                <Link to="#">
                  <img
                    src="https://luxuryride.in/_next/image?url=https%3A%2F%2Fapi.luxuryride.in%2Fpublic%2Ftestimonial%2Fuser_image-mask-group-38.png&w=1920&q=75"
                    alt="Abertura de novos escritórios da empresa"
                    loading="lazy"
                    className="w-100"
                  />
